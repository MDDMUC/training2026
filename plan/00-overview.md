...
> **Archived 2026-08.** This H2 2026 macrocycle is Previous plan in the app — not deleted. Active work is [`08-reentry.md`](08-reentry.md) (conservative Pull / Push / Run, Wed 2 Sep → Tue 29 Sep). Hangboard and climbing stay off until after that block.
...
- Weighted pull-up: **+18 kg × 5 reps at 82 kg BW** → estimated 1RM ≈ +35 kg added.
- Running re-entry: 5 km @ 8:30/km, pain-free, knee 28 months post-op.

**Goals:**
1. Drive weighted pull-up 1RM toward **+50–55 kg added** (167%+ BW).
2. Drive 20 mm finger peak past **+60 kg per hand**, with **<3% asymmetry**.
3. Reach **controlled bodyweight deep squat**, hip + hamstring flexibility unrestricted.
4. Sub-focus: rebuild running to **30 min easy at <8:00/km** without knee issues.
...
## What's locked vs. what gets recalibrated

**Locked for the full 12 weeks:**
- The weekly day-of-week rhythm above.
- The pull-push-rest split with weekend outdoor priority.
- Daily mobility commitment.
- Asymmetry-first finger work (L hand trained first while fresh, every session).
- Hooper's 3-step warm-up before every finger session.
- 24-hour pain rule on the left middle finger — overrides the plan if triggered.

**Recalibrated at end of each phase (Weeks 4, 8, 12):**
- Tindeq peak force (R + L) → drives the next phase's % MVC loads.
- Weighted pull-up 1RM → drives the next phase's pull loads.
- Asymmetry % → if <3%, drop the bias and run balanced sessions.
- Subjective: deep-squat depth, run pace at same RPE, lingering pulley sensation.

**Sources informing this plan:**
- `../context/synthesis.md` — integrated coaching position
- `../context/research_lattice.md` — benchmarks + max-hang dose
- `../context/research_camp4hp_nelson.md` — Density Hangs, asymmetry, 24-hour rule
- `../context/research_hoopers_beta.md` — warm-up, minimalist supersets, mobility
- `../context/research_periodization.md` — phase ordering, concurrent training
...
- `01-weekly-template.md` — the canonical week, with phase-specific deltas
- `02-phase1-base-tendon-prep.md` — full week-by-week for weeks 1–4
- `03-phase2-max-strength.md` — outline for weeks 5–8 (detailed after Week 4 test)
...
- `08-reentry.md` — **active** 4-week conservative Pull / Push / Run (Wed 2 Sep → Tue 29 Sep)
